...
const ChevronDownIcon = () => (
  ...
  >
    <path
      d="M12.0581 5.05812L7.50002 9.61625L2.9419 5.05812L2.05814 5.94187L7.50002 11.3837L12.9419 5.94187L12.0581 5.05812Z"
      fill="black"
    />
  </svg>
);
      ...
      <div className="max-w-[1200px] mx-auto h-full flex items-center justify-between py-[31px]">
        ...
        <nav className="hidden lg:flex items-center gap-[15px]">
          <div className="flex items-center">
            <span className="font-yu-gothic text-[14px] font-medium text-black leading-[130%]">
              会社概要
            </span>
            <ChevronDownIcon />
          </div>
          <Link
            to="/business"
            className="font-yu-gothic text-[14px] font-medium text-black leading-[130%]"
          >
            事業内容
          </Link>
          <Link
        ...
        <nav className="lg:hidden border-t border-black/30 bg-white p-4">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <span className="font-yu-gothic text-[14px] font-medium text-black">
                会社概要
              </span>
              <ChevronDownIcon />
            </div>
            <Link
              to="/business"
              className="font-yu-gothic text-[14px] font-medium text-black"
            >
              事業内容
            </Link>
            <Link
  ...
  const tableData = [
    {
      label: "商号",
      content:
        "和名：NYK Energy Ocean株式会社（エヌワイケイ・エナジー・オーシャン株式会社）\n英名：NYK Energy Ocean Corporation",
    },
    {
      label: "設立年月日",
      content: "2024年8月8日",
                ...
                <span
                  dangerouslySetInnerHTML={{
                    __html: row.content
                      .replace(
                        /日本郵船株式会社/g,
                        '<span class="underline">日本郵船株式会社</span>',
                      )
                      .replace(
                        /ＥＮＥＯＳオーシャン株式会社/g,
                        '<span class="underline">ＥＮＥＯＳオーシャン株式会社</span>',
                      )
                      .replace(
                        /NYK Energy Ocean Shipmanagement Pte Ltd/g,
                        '<span class="underline">NYK Energy Ocean Shipmanagement Pte Ltd</span>',
                      ),
                  }}
                />
              ) : (
      ...
      <div className="max-w-[1200px] mx-auto py-[60px_0_40px_0] flex flex-col lg:flex-row items-start gap-6">
        <div className="flex-1 flex flex-col gap-[30px]">
          ...
          <div className="font-yu-gothic text-[14px] text-black leading-[130%]">
            ...
            〒220-0012　神奈川県横浜市西区みなとみらい三丁目6番3号
            (MMパークビル13階)
          </div>
        </div>
        ...
        <div className="flex gap-[15px]">
          <div className="flex flex-col gap-[15px] w-[70px]">
            <Link
              to="/company"
              className="font-inter text-[14px] text-black leading-[130%]"
            >
              会社概要
            </Link>
            <Link
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 flex flex-col items-center gap-[30px] px-4 lg:px-0">
        <div className="w-full max-w-[1200px] flex flex-col gap-[10px] pb-[30px] pt-[30px]">
          ...
          <h1 className="font-yu-gothic text-[20px] font-bold text-black">
            会社概要
          </h1>

          <h2 className="font-yu-gothic text-[16px] font-bold text-black/85 w-full">
            会社概要
          </h2>

          <CompanyTable />

          <h2 className="font-yu-gothic text-[16px] font-bold text-black/85 w-full mt-[30px]">
            組織図
          </h2>
